...
const main = async () => {
    try {
        ...
        const server = new McpServer({ name: "honcho-mcp", version: "0.1.0" }, { capabilities: { logging: {}, tools: {} } });
        ...
        console.error("[honcho-mcp FATAL]", error instanceof Error ? error.message : String(error));
        process.exit(1);
    }
};
main().catch((error) => {
