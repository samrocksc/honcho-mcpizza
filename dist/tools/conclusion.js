...
export const registerConclusionTools = (server, layer) => {
    server.registerTool("conclusion_create", {
        ...
        const result = yield* client.request("POST", `/workspaces/${args.workspace_id}/conclusions`, { conclusions: args.conclusions });
        return renderTool(result);
    }).pipe(Effect.provide(layer), Effect.catchTag("HonchoClientError", (e) => Effect.succeed(renderError(e))))));
    server.registerTool("conclusion_list", {
        ...
        const client = yield* HonchoClient;
        const result = yield* client.request("POST", `/workspaces/${args.workspace_id}/conclusions/list`, { page: args.page, size: args.size, reverse: args.reverse, filters: args.filters });
        return renderTool(result);
    }).pipe(Effect.provide(layer), Effect.catchTag("HonchoClientError", (e) => Effect.succeed(renderError(e))))));
    server.registerTool("conclusion_query", {
        ...
        const client = yield* HonchoClient;
        const result = yield* client.request("POST", `/workspaces/${args.workspace_id}/conclusions/query`, { query: args.query, top_k: args.top_k, distance: args.distance, filters: args.filters });
        return renderTool(result);
    }).pipe(Effect.provide(layer), Effect.catchTag("HonchoClientError", (e) => Effect.succeed(renderError(e))))));
    server.registerTool("conclusion_delete", {
        ...
        const client = yield* HonchoClient;
        yield* client.request("DELETE", `/workspaces/${args.workspace_id}/conclusions/${args.conclusion_id}`);
